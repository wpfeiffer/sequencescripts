#!/usr/bin/perl
# identify-species picks the best match between each contig of a sample and a genome database and then outputs the total number of contigs and the matching length by species above and below a specified identity threshold.
#
