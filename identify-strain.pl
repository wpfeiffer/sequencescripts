#!/usr/bin/perl
# identify-strain picks the best match between each contig of a sample and a genome database an
d then outputs the total number of contigs and the matching length by strain above and below a
specified identity threshold.
#
